...
public:
  ...
  inline CPosition(void) { m_Latitude = m_Longitude = 0.0; };
...
public:
  ...
  inline CFlightPlanExtractedRoute(void) { m_FpPosition = NULL; };
...
public:
  ...
  inline CFlightPlanPositionPredictions(void) { m_FpPosition = NULL; };
...
public:
  ...
  inline bool IsValid(void) const { return m_RtPosition != NULL; };
  //-----------------------------------------------------------------
  //  Return :
  ...
  inline bool IsFPTrackPosition(void) const { return m_PosPosition == NULL; };
  //-----------------------------------------------------------------
  //  Return :
...
public:
  ...
  inline CFlightPlanData(void) { m_FpPosition = NULL; };
...
public:
  ...
  inline CFlightPlanControllerAssignedData(void) { m_FpPosition = NULL; };
...
public:
  ...
  inline CFlightPlan(void) { m_FpPosition = NULL; };

  //---IsValid-------------------------------------------------------

  inline bool IsValid(void) const { return m_FpPosition != NULL; };
  //-----------------------------------------------------------------
  //  Return :
...
public:
  ...
  inline CRadarTarget(void) { m_RtPosition = NULL; };
...
public:
  ...
  inline bool IsValid(void) const { return m_CtrPosition != NULL || m_Myself; };
  //-----------------------------------------------------------------
  //  Return :
...
public:
  ...
  inline CFlightPlanList(void) { m_Position = NULL; };

  //---IsValid-------------------------------------------------------

  inline bool IsValid(void) const { return m_Position != NULL; };
...
public:
  ...
  inline bool IsValid(void) const { return m_Position != -1; };
  //-----------------------------------------------------------------
  //  Return :
  //      true    - if the CTR reference is valid
  //      false   - else
  ...
  inline int GetElementType(void) const { return m_ElementType; };
...
public:
  inline CGrountToAirChannel(void) { m_Index = -1; }

  //---IsValid-------------------------------------------------------

  inline bool IsValid(void) const { return m_Index != -1; };
  //-----------------------------------------------------------------
  //  Return :
  //      true    - if the CTR reference is valid
  //      false   - else
...
public:
  ...
  //                        TAG_COLOR_DEFAULT - indicates the default for AC
  //                        state TAG_COLOR_RGB_DEFINED - do not use and
